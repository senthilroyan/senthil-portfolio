    ...
    return (
        <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300">
            ...
            <ul className='hidden md:flex'>
                ...
                <li>
                    <Link to="work" smooth={true} duration={500} offset={8}>
                        Work
                    </Link>
                </li>
                <li>
            ...
            <ul className={!nav ? 'hidden' : 'absolute top-0 left-0 w-full h-screen bg-[#0a192f] flex flex-col justify-center item-center'}>
                ...
                <li className='py-6 text-4xl'>
                    <Link onClick={handleClick} to="work" smooth={true} duration={500} offset={8}>
                        Work
                    </Link>
                </li>
                <li className='py-6 text-4xl'>
                    <Link onClick={handleClick} to="contact" smooth={true} duration={500} offset={-68}>
                        Contact
                    </Link>
                </li>
            </ul>
